      ...
      <section className="container mx-auto px-4 pt-0 pb-16 md:pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 items-center">
          ...
          <div>
            ...
            <a href="https://w.app/paragliding" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 bg-[#1a1a1a] hover:bg-[#222] border border-gray-700 hover:border-orange-500/50 text-white pl-2 pr-5 py-2 rounded-full transition-all duration-300">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://open.spotify.com/show/16jBM3RfjVERukNHJrIRec" target="_blank" rel="noopener noreferrer" className="bg-[#1DB954] hover:bg-[#1aa34a] text-white px-6 py-2 rounded-lg transition flex items-center gap-2 font-semibold">
            ...
            <a href="https://podcasts.apple.com/us/podcast/paragliding-atlas-by-aninder-singh/id1735782803" target="_blank" rel="noopener noreferrer" className="bg-[#872EC4] hover:bg-[#7325a8] text-white px-6 py-2 rounded-lg transition flex items-center gap-2 font-semibold">
            ...
            <a href="https://music.amazon.com/podcasts/44399f7e-fef1-4db1-9a60-7c9ef74df2b4/paragliding-atlas-by-aninder-singh" target="_blank" rel="noopener noreferrer" className="bg-[#00A8E0] hover:bg-[#0090c0] text-white px-6 py-2 rounded-lg transition flex items-center gap-2 font-semibold">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M.045 18.02c.072-.116.187-.124.348-.022 3.636 2.11 7.594 3.166 11.87 3.166 2.852 0 5.668-.533 8.447-1.595l.315-.14c.138-.06.234-.1.293-.13.226-.088.39-.046.525.13.12.174.09.336-.12.48-.256.19-.6.41-1.006.654-1.244.743-2.64 1.316-4.185 1.726a17.617 17.617 0 01-10.951-.577 17.88 17.88 0 01-5.43-3.35c-.1-.074-.151-.15-.151-.22 0-.047.021-.09.051-.13zm6.565-6.218c0-1.005.247-1.863.743-2.577.495-.71 1.17-1.25 2.04-1.615.796-.335 1.756-.575 2.912-.72.39-.046 1.033-.103 1.92-.174v-.37c0-.93-.105-1.558-.3-1.875-.302-.43-.78-.65-1.44-.65h-.182c-.48.046-.896.196-1.246.46-.35.27-.575.63-.675 1.096-.06.3-.206.465-.435.51l-2.52-.315c-.248-.06-.372-.18-.372-.39 0-.046.007-.09.022-.15.247-1.29.855-2.25 1.82-2.88.976-.616 2.1-.975 3.39-1.05h.54c1.65 0 2.957.434 3.888 1.29.135.15.27.3.405.48.12.165.224.314.283.45.075.134.15.33.195.57.06.254.105.42.135.51.03.104.062.3.076.615.01.313.02.493.02.553v5.28c0 .376.06.72.165 1.036.105.313.21.54.315.674l.51.674c.09.136.136.256.136.36 0 .12-.06.226-.18.314-1.2 1.05-1.86 1.62-1.963 1.71-.165.135-.375.15-.63.045a6.062 6.062 0 01-.526-.496l-.31-.347a9.391 9.391 0 01-.317-.42l-.3-.435c-.81.886-1.603 1.44-2.4 1.665-.494.15-1.093.227-1.83.227-1.11 0-2.04-.343-2.76-1.034-.72-.69-1.08-1.665-1.08-2.94l-.05-.076zm3.753-.438c0 .566.14 1.02.425 1.364.285.34.675.512 1.155.512.045 0 .106-.007.195-.02.09-.016.134-.023.166-.023.614-.16 1.08-.553 1.424-1.178.165-.28.285-.58.36-.91.09-.32.12-.59.135-.8.015-.195.015-.54.015-1.005v-.54c-.84 0-1.484.06-1.92.18-1.275.36-1.92 1.17-1.92 2.43l-.035-.02z"/></svg>
              <span>Amazon Music</span>
            </a>
            <a href="https://www.youtube.com/@ParaglidingAtlas" target="_blank" rel="noopener noreferrer" className="bg-[#FF0000] hover:bg-[#cc0000] text-white px-6 py-2 rounded-lg transition flex items-center gap-2 font-semibold">
